	...
	switch(pil){
		...
		case 3:
			...
			for(int i=1;i<=round;i++){
				cout<<"\nMasukkan kertas/gunting/batu "<<p1<<" : "; cin>>gbkp1;
				cout<<"Masukkan kertas/gunting/batu "<<p2<<" : "; cin>>gbkp2;
			
				 if(gbkp1=="kertas"&&gbkp2=="batu"){ //p1 kertas
					winp1+=1;
				} else if(gbkp1=="kertas"&&gbkp2=="gunting"){
					winp2+=1;
				} else if(gbkp1=="gunting"&&gbkp2=="kertas"){ //p1 gunting 
					winp1+=1;
				}  else if(gbkp1=="gunting"&&gbkp2=="batu"){  
					winp2+=1;
				} else if(gbkp1=="batu"&&gbkp2=="gunting"){ //p1 batu
					winp1+=1;
				} else if(gbkp1=="batu"&&gbkp2=="kertas"){ 
					winp2+=1;
				} else if(gbkp1==gbkp2){
					winp1+=0;
					winp2+=0;
			...
			cout<<endl<<p2<<" menang "<<winp2<<" kali";
			cout<<endl;
